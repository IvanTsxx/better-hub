    ...
    fetch("/api/user-settings")
      ...
      .then((settings) => {
        ...
        const dbPrefs: CodeThemePreferences = {
          codeThemeLight: settings.codeThemeLight ?? DEFAULT_CODE_THEME_LIGHT,
          codeThemeDark: settings.codeThemeDark ?? DEFAULT_CODE_THEME_DARK,
          codeFont: settings.codeFont ?? DEFAULT_CODE_FONT,
          codeFontSize: settings.codeFontSize ?? DEFAULT_CODE_FONT_SIZE,
        };
