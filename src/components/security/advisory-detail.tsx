          ...
          {advisory.cvss && (
            <div className="border border-border p-3 space-y-1.5">
              ...
              <div className="flex items-baseline gap-2">
                <span className={cn("text-xl font-mono font-medium", sev.text)}>
            ...
            <div className="border border-border p-3 space-y-1.5">
              ...
              <div className="space-y-1">
                {advisory.cwes.map((cwe) => (
                  <div key={cwe.cweId} className="text-xs">
              ...
              <div className="space-y-2">
                {advisory.credits.map((credit, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <span className="text-xs">{credit.login}</span>
            ...
            <div className="border border-border p-3 space-y-1.5">
              ...
              <div className="flex items-center gap-2">
                {advisory.author.avatarUrl ? (
                  <Image
                    src={advisory.author.avatarUrl}
                    alt={advisory.author.login}
                    width={20}
                    height={20}
                    className="rounded-full"
                  />
                ...
                <span className="text-xs">{advisory.author.login}</span>
              </div>
            </div>
          )}
